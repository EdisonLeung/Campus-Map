...
public class MarvelTestDriver {
    ...
    private void listChildren(String graphName, String parentName) {
        Set<Graph.Edge<String, String>> edges = graphs.get(graphName).getChildren(parentName);
        List<Graph.Edge<String, String>> rval = new ArrayList<>(edges);
        ...
        for (Graph.Edge<String, String> edge: rval) {
            output.print(" " + edge);
        }
        output.println();
    }
    ...
    private void findPath(String graphName, String startNode, String destNode) {
        ...
        if (graphs.get(graphName).containsNode(startNode) && graphs.get(graphName).containsNode(destNode)) {
            ...
            List<Graph.Edge<String, String>> shortestPath = MarvelPaths.findPath(graphs.get(graphName), startNode, destNode);
            if (shortestPath == null) {
                output.println("no path found");
            } else {
                String node = startNode;
                for (Graph.Edge<String, String> edge : shortestPath) {
