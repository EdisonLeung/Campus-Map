...
import campuspaths.graph.Graph;
...
public class CampusMap implements ModelAPI {
    ...
    public Point getBuildingLocation(String shortName) {
        checkRep();
        if (shortName == null) {
            throw new IllegalArgumentException("given param is null");
        }

        return new Point(buildings.get(shortName).getX(), buildings.get(shortName).getY());
    }
